...
- `og.jpg` (1200×630) = image de partage social, référencée en **URL absolue**.
...
3. S'assurer que `CNAME`, `.nojekyll`, `og.jpg` sont présents.
...
## Image OG
- 1200×630, PNG/JPG, < ~1 Mo. Doit rester une **URL absolue** `https://portofolio.la-zone.io/og.jpg`
  (les `data:` URIs et chemins relatifs ne marchent pas pour les crawlers sociaux).
- Pour la régénérer depuis une nouvelle source : déposer l'image, la recadrer en 1200×630, écraser `og.jpg`.
